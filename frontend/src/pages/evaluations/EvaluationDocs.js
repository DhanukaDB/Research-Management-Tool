...
export default function EvaluationDocs() {
  ...
  function deleteDoc(_id) {
    axios.delete(`http://localhost:5000/api/evaluateDocs/delete/${_id}`)
      .then((res) => {
        //console.log(res.data);
        window.location = `/EvaluationDocs`;
      })
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button
                      ...
                      onClick={() => { if (window.confirm('Are you sure you wish to delete this record?')) deleteDoc(marksDocs._id) }}
                    >
